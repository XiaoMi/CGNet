...
from .distance import pairwise, chamfer_distance, frechet_distance
from .io import io
...
def openlane_evaluate(ground_truth, predictions, verbose=True):
    r"""
    ...
    metrics['TOP_ll'] = _mAP_topology_lclc(gts, preds, THRESHOLDS_FRECHET)

    metrics['DET_l_c'] = _mAP_over_threshold(
        gts=gts, 
        preds=preds, 
    ...
    metrics['TOP_ll_c'] = _mAP_topology_lclc(gts, preds, THRESHOLDS_CHAMFER)

    # metrics['score'] = np.asarray([
